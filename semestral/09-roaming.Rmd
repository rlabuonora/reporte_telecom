...
## 103. Tráfico de voz de Roaming (minutos)
```{r}
serie_166 <- roaming %>% 
...
## 104. Tráfico de voz de Roaming (minutos) por operador (`r FECHA_TITULO_FLUJO`)
```{r}
serie_167 <- roaming %>% 
  filter(voz == "Tráfico de voz") %>%
  filter(destino %in% c("RL", "RLDI", "RS")) %>% 
...
## 105. Tráfico de voz de Roaming (minutos) por tipo de servicio (`r FECHA_TITULO_FLUJO`)
...
## 106. Tráfico de voz de Roaming Local (minutos)
...
## 107. Tráfico de voz de Roaming Local (minutos) por operador (`r FECHA_TITULO_FLUJO`)
...
## 108. Tráfico de voz de Roaming Saliente (minutos)
...
## 109. Tráfico de voz de Roaming Saliente (minutos) por operador (`r FECHA_TITULO_FLUJO`)
...
## 110. Tráfico de voz de Roaming de LDI (minutos) por operador (`r FECHA_TITULO_FLUJO`)
...
## 111. Tráfico de datos de Roaming (terabytes) por operador
