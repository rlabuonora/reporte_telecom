...
## 5.3. Servicios de TV para abonados en Artigas
```{r}
abonados_por_depto %>% 
...
## 5.5. Servicios de TV para abonados en Canelones
```{r}
abonados_por_depto %>% 
...
## 5.9. Servicios de TV para abonados en Colonia
```{r}
abonados_por_depto %>% 
...
## 5.11. Servicios de TV para abonados en Durazno
```{r}
abonados_por_depto %>% 
...
## 5.13. Servicios de TV para abonados en Flores
```{r}
abonados_por_depto %>% 
  filter(depto=="Flores") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.15. Servicios de TV para abonados en Florida
```{r}
abonados_por_depto %>% 
...
## 5.17. Servicios de TV para abonados en Lavalleja
```{r}
abonados_por_depto %>% 
...
## 5.19. Servicios de TV para abonados en Maldonado
```{r}
abonados_por_depto %>% 
...
## 5.4. Servicios de TV para abonados por operador en Montevideo (`r FECHA_TITULO_STOCK`)
```{r}
tribble(
  ~empresa,         ~abonados,
  "Bersabel S.A.", 58494,
...
## 5.23. Servicios de TV para abonados en Paysandú
```{r}
abonados_por_depto %>% 
...
## 5.25. Servicios de TV para abonados en Río Negro
```{r}
abonados_por_depto %>% 
...
## 5.27. Servicios de TV para abonados en Rivera
```{r}
abonados_por_depto %>% 
  filter(depto=="Rivera") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.29. Servicios de TV para abonados en Rocha
```{r}
abonados_por_depto %>% 
  filter(depto=="Rocha") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.31. Servicios de TV para abonados en Salto
```{r}
abonados_por_depto %>% 
  filter(depto=="Salto") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.33. Servicios de TV para abonados en San José
```{r}
abonados_por_depto %>% 
...
## 5.33. Servicios de TV para abonados en Soriano
```{r}
abonados_por_depto %>% 
...
## 5.35. Servicios de TV para abonados en Tacuarembó
```{r}
abonados_por_depto %>% 
...
## 5.37. Servicios de TV para abonados en Treinta y Tres
```{r}
abonados_por_depto %>% 
...
## 5.43. Servicios de TV para abonados Satelital
```{r}
abonados_por_tecnologia %>% 
