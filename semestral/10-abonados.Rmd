...
## 5.3. Cantidad de Abonados en Artigas
```{r}
abonados_por_depto %>% 
...
## 5.4. Abonados en Artigas por operador (`r FECHA_TITULO_STOCK`)
```{r}
...
## 5.5. Cantidad de Abonados en Canelones
```{r}
abonados_por_depto %>% 
...
## 5.6. Abonados en Canelones por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Canelones") %>% 
...
## 5.7. Cantidad de Abonados en Cerro Largo
```{r}
abonados_por_depto %>% 
...
## 5.8. Abonados en Cerro Largo por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Cerro largo") %>% 
...
## 5.9. Cantidad de Abonados en Colonia
```{r}
abonados_por_depto %>% 
...
## 5.10. Abonados en Colonia por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Colonia") %>% 
...
## 5.11. Cantidad de Abonados en Durazno
```{r}
abonados_por_depto %>% 
...
## 5.12. Abonados en Durazno por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Durazno") %>% 
...
## 5.13. Cantidad de Abonados en Flores
```{r}
abonados_por_depto %>% 
  filter(depto=="Flores") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.14. Abonados en Flores por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Flores") %>% 
...
## 5.15. Cantidad de Abonados en Florida
```{r}
abonados_por_depto %>% 
...
## 5.16. Abonados en Florida por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Florida") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.17. Cantidad de Abonados en Lavalleja
```{r}
abonados_por_depto %>% 
...
## 5.18. Abonados en Lavalleja por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Lavalleja") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.19. Cantidad de Abonados en Maldonado
```{r}
abonados_por_depto %>% 
...
## 5.20. Abonados en Maldonado por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Maldonado") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.21. Servicios de TV para Abonados en Montevideo
```{r}
abonados_por_depto %>% 
...
## 5.22. Abonados en Montevideo por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Montevideo") %>% 
...
## 5.23. Cantidad de Abonados en Paysandú
```{r}
abonados_por_depto %>% 
...
## 5.24. Abonados en Paysandú por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Paysandú") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 2000)
...
## 5.25. Cantidad de Abonados en Río Negro
```{r}
abonados_por_depto %>% 
...
## 5.26. Abonados en Río Negro por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Río Negro") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.27. Cantidad de Abonados en Rivera
```{r}
abonados_por_depto %>% 
  filter(depto=="Rivera") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.28. Abonados en Rivera por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Rivera") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.29. Cantidad de Abonados en Rocha
```{r}
abonados_por_depto %>% 
  filter(depto=="Rocha") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.30. Abonados en Rocha por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Rocha") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.31. Cantidad de Abonados en Salto
```{r}
abonados_por_depto %>% 
  filter(depto=="Salto") %>% 
  filter(year(fecha) >= 2017) %>% 
...
## 5.32. Abonados en Salto por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Salto") %>% 
...
## 5.33. Cantidad de Abonados en San José
```{r}
abonados_por_depto %>% 
...
## 5.34. Abonados en San José por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="San José") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.35. Cantidad de Abonados en Tacuarembó
```{r}
abonados_por_depto %>% 
...
## 5.36. Abonados en Tacuarembó por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Tacuarembó") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 500)
...
## 5.37. Cantidad de Abonados en Treinta y Tres
```{r}
abonados_por_depto %>% 
...
## 5.38. Abonados en Treinta y Tres por operador (`r FECHA_TITULO_STOCK`)
```{r}
abonados_por_operador_depto %>% 
    filter(depto=="Treinta y tres") %>% 
    barras_horizontales(abonados, empresa, nudge_text = 300)
...
## 5.39. Servicios de TV para abonados por tecnología (`r FECHA_TITULO_STOCK`)
```{r}
...
## 5.41. Servicios de TV para abonados por UHF
```{r}
abonados_por_tecnologia %>% 
...
## 5.43. Servicios de TV para abonados por Satelital
```{r}
abonados_por_tecnologia %>% 
