...
## 43. Servicios de banda ancha fija según alámbrica e inalámbrica (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 44. Servicios de banda ancha fija por velocidad (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 45. Servicios de banda ancha fija por tipo de cliente (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 46. Servicios de banda ancha fija por operador (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 47. Servicios de banda ancha fija por medio de trasmisión (`r FECHA_INFORME_TITULOS`)
```{r}
...
serie_69 <- banda_ancha_servicios_residenciales %>% 
  ...
  summarize(servicios = sum(val, na.rm = TRUE)) %>% 
  serie_historica_semestral(servicios, nudge_text = 8e4)

serie_69
```


## 49. Servicios de banda ancha fija residencial por velocidad (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 50. Servicios de banda ancha fija residencial por operador (`r FECHA_INFORME_TITULOS`)
...
## 51. Servicios de banda ancha fija residencial por medio de trasmisión (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 53. Servicios de banda ancha fija comercial por velocidad (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 54. Servicios de banda ancha fija comercial por operador (`r FECHA_INFORME_TITULOS`)
...
## 55. Servicios de banda ancha fija comercial por medio de trasmisión (`r FECHA_INFORME_TITULOS`)
```{r}
...
banda_ancha_servicios_inalambrica %>% 
  ...
  group_by(year=year(fecha), semester=semester(fecha)) %>%
  summarize(servicios = sum(val, na.rm = TRUE)) %>% 
  serie_historica_semestral(servicios, nudge_text = 2e3)
```

## 57. Servicios de banda ancha fija inalámbrica por velocidad (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 58. Servicios de banda ancha fija inalámbrica por tipo de cliente (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 59. Servicios de banda ancha fija inalámbrica por operador (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 60. Servicios de banda ancha fija inalámbrica por medio de trasmisión (`r FECHA_INFORME_TITULOS`)
```{r}
...
banda_ancha_servicios_alambrica %>% 
  ...
  group_by(year=year(fecha), semester=semester(fecha)) %>%
  summarize(servicios = sum(val, na.rm = TRUE)) %>% 
  serie_historica_semestral(servicios, nudge_text = 4e3)
```


## 62. Servicios de banda ancha fija alámbrica por velocidad (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 63. Servicios de banda ancha fija alámbrica por medio de trasmisión (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 64. Servicios de banda ancha fija alámbrica por tipo de cliente (`r FECHA_INFORME_TITULOS`)
```{r}
...
## 65. Servicios de banda ancha fija alámbrica por operador (`r FECHA_INFORME_TITULOS`)
...
## 67. Tráfico de datos de servicios de banda ancha fija (terabytes) según alámbrica e inalámbrica (`r FECHA_INFORME_TITULOS`)
...
## 68. Tráfico de datos se servicios de banda ancha fija (terabytes) según tipo de cliente (`r FECHA_INFORME_TITULOS`)
...
## 69. Tráfico de datos (terabytes) por operador (`r FECHA_INFORME_TITULOS`)
