...
## 3.29. Capacidad propia de acceso a Internet (Mbps) (`r FECHA_TITULO_FLUJO`)
```{r}
...
## 3.30. Capacidad propia de acceso a Internet por operador (megabytes) (`r FECHA_TITULO_STOCK`)
```{r}
