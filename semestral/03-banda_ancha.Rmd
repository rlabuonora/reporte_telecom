...
X. Capacidad propioa de acceso a Internet (Mbps) (`r FECHA_TITULO_FLUJO`)
```{r}
...
tribble(
  ...
  serie_historica_semestral_flujo(val, nudge_text=10e3)
...
tribble(
  ...
  pie_chart(val, empresa, nudge_x = c(0, 0, 0)) %>% 
  print
