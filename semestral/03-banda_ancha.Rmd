...
## 1. Servicios de banda ancha fija
```{r}
# g_63
...
## 2. Servicios de banda ancha fija según alámbrica e inalámbrica (`r FECHA_TITULO_STOCK`)
```{r}
...
## 3. Servicios de banda ancha fija por velocidad (`r FECHA_TITULO_STOCK`)
```{r}
...
## 4. Servicios de banda ancha fija por tipo de cliente (`r FECHA_TITULO_STOCK`)
```{r}
...
## 5. Servicios de banda ancha fija por operador (`r FECHA_TITULO_STOCK`)
```{r}
...
## 6. Servicios de banda ancha fija por medio de trasmisión (`r FECHA_TITULO_STOCK`)
```{r}
...
## 7. Servicios de banda ancha fija residencial
```{r}
...
## 8. Servicios de banda ancha fija residencial por velocidad (`r FECHA_TITULO_STOCK`)
```{r}
...
## 9. Servicios de banda ancha fija residencial por operador (`r FECHA_TITULO_STOCK`)
...
## 10. Servicios de banda ancha fija residencial por medio de trasmisión (`r FECHA_TITULO_STOCK`)
```{r}
...
## 11. Servicios de banda ancha fija comercial
```{r}
...
## 12. Servicios de banda ancha fija comercial por velocidad (`r FECHA_TITULO_STOCK`)
```{r}
...
## 13. Servicios de banda ancha fija comercial por operador (`r FECHA_TITULO_STOCK`)
...
## 14. Servicios de banda ancha fija comercial por medio de trasmisión (`r FECHA_TITULO_STOCK`)
```{r}
...
## 15. Servicios de banda ancha fija inalámbrica
```{r}
...
## 16. Servicios de banda ancha fija inalámbrica por velocidad (`r FECHA_TITULO_STOCK`)
```{r}
...
## 17. Servicios de banda ancha fija inalámbrica por tipo de cliente (`r FECHA_TITULO_STOCK`)
```{r}
...
## 18. Servicios de banda ancha fija inalámbrica por operador (`r FECHA_TITULO_STOCK`)
```{r}
...
## 19. Servicios de banda ancha fija inalámbrica por medio de trasmisión (`r FECHA_TITULO_STOCK`)
```{r}
...
## 20. Servicios de banda ancha fija alámbrica
```{r}
...
## 21. Servicios de banda ancha fija alámbrica por velocidad (`r FECHA_TITULO_STOCK`)
```{r}
...
## 22. Servicios de banda ancha fija alámbrica por medio de trasmisión (`r FECHA_TITULO_STOCK`)
```{r}
...
## 23. Servicios de banda ancha fija alámbrica por tipo de cliente (`r FECHA_TITULO_STOCK`)
```{r}
...
## 24. Servicios de banda ancha fija alámbrica por operador (`r FECHA_TITULO_STOCK`)
...
## 25. Tráfico de datos de servicios de banda ancha fija (terabytes)
```{r}
# banda_ancha_trafico %>% 
...
## 26. Tráfico de datos de servicios de banda ancha fija (terabytes) según alámbrica e inalámbrica (`r FECHA_TITULO_FLUJO`)
...
## 27. Tráfico de datos se servicios de banda ancha fija (terabytes) según tipo de cliente (`r FECHA_TITULO_FLUJO`)(*)
...
## 28. Tráfico de datos (terabytes) por operador (`r FECHA_TITULO_FLUJO`)(*)
...
## 29. Capacidad propia de acceso a Internet (Mbps) (`r FECHA_TITULO_FLUJO`)
```{r}
...
## 30. Capacidad propia de acceso a Internet por operador (`r FECHA_TITULO_STOCK`)
```{r}
