...
## 19. Minutos de tráfico de LDI saliente por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 20. Minutos de tráfico de LDI saliente según red origen (`r FECHA_INFORME_TITULOS_2`)
```{r}
serie_28 <- ldi %>%
...
## 21. Minutos de tráfico de LDI salientes de red fija - AMM por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 23. Minutos de tráfico de LDI salientes de red fija - Resto País por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 26. Minutos de tráfico de LDI saliente por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 27. Minutos de tráfico de LDI saliente de red móvil de ANTEL por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 29. Minutos de tráfico de LDI saliente de red móvil de MOVISTAR por operador (`r FECHA_INFORME_TITULOS_2`)
```{r}
serie_37 <- ldi %>% 
...
## 31. Minutos de tráfico de LDI saliente de red móvil de CLARO por operador (`r FECHA_INFORME_TITULOS_2`)
...
## 33. Minutos de tráfico de LDI saliente de Telefonía Fija según cliente ( `r FECHA_INFORME_TITULOS_2`)
```{r}
serie_41 <- ldi %>% 
...
## 36. Minutos de tráfico de LDI saliente por destino (`r FECHA_INFORME_TITULOS_2`)
