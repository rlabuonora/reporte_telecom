...
## 101. Suscriptores a la telefonía móvil celular según forma de pago (`r FECHA_TITULO_STOCK`)
```{r}
serie_121 <- servicios %>% 
...
## 103. Suscriptores prepagos a la telefonía móvil celular por operador (`r FECHA_TITULO_STOCK`)
```{r}
serie_123 <- servicios %>% 
  filter(servicio == "Suscriptores a la telefonía móvil celular") %>% 
  filter(pago == "Prepago") %>% 
...
## 114. Servicios M2M popagos por operador (`r FECHA_TITULO_STOCK`)
...
## 115. Suscriptores pospagos de banda ancha móvil (no va en el semestral)
```{r}
# serie_135 <- servicios %>% 
#   filter(servicio == "Suscriptores de banda ancha móvil") %>%
#   filter(pago == "Pospago") %>% 
