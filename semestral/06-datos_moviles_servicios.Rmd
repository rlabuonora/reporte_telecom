...
serie_112 %>% 
  serie_historica_semestral(val / 1e3, nudge_text = 300) +
  labs(y="Miles")
```
...
serie_118 %>% 
  serie_historica_semestral(val/1e3, nudge_text = 2e2) +
  labs(y="Miles")
```
...
serie_126 %>% 
  serie_historica_semestral(val, nudge_text = .15)
```
...
serie_127 %>% 
  serie_historica_semestral(val/1e3, nudge_text = 1e2) + 
  labs(y="Miles")
```
