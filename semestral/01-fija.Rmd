...
## 1.2. Líneas de telefonía fija por departamento (`r FECHA_TITULO_STOCK`)
...
## 1.4. Teléfonos públicos por departamento (`r FECHA_TITULO_STOCK`)
...
## 1.5. Líneas de telefonía fija por tipo de cliente (`r FECHA_TITULO_STOCK`)
...
## 1.6. Líneas de telefonía fija comerciales
...
## 1.7. Líneas de telefonía fija Comerciales por departamento (`r FECHA_TITULO_STOCK`)
...
## 1.8. Líneas de telefonía fija residenciales
...
## 1.9. Líneas de telefonía fija Residenciales por departamento (`r FECHA_TITULO_STOCK`)
...
## 1.10. Kilómetros de fibra óptica instalada
...
## 1.11. Kilómetros de fibra óptica instalada por departamento (`r FECHA_TITULO_STOCK`)
...
## 1.12. Cómputos de telefonía fija
...
## 1.13. Minutos de telefonía fija a teléfonos móviles
...
## 1.14. Minutos de tráfico de telefonía fija a teléfonos móviles por operador (`r FECHA_TITULO_FLUJO`)
...
## 1.15. Minutos de tráfico de telefonía fija a red móvil de ANTEL
...
## 1.16. Minutos de tráfico de telefonía fija a red móvil de Movistar
...
## 1.17. Minutos de tráfico de telefonía fija a red móvil de Claro
