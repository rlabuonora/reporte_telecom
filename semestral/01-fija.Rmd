...
## 2. Líneas de telefonía fija por departamento (`r FECHA_INFORME_TITULOS`)
...
## 4. Teléfonos públicos por departamento (`r FECHA_INFORME_TITULOS`)
```{r}
fija %>% 
  filter(cabezal_1 == "Líneas") %>% 
  filter(cabezal_2 %in% c("Púb.R", "Púb.U")) %>% 
...
## 5. Líneas de telefonía fija por tipo de cliente (`r FECHA_INFORME_TITULOS`)
...
## 7. Líneas de telefonía fija Comerciales por departamento (`r FECHA_INFORME_TITULOS`)
...
## 9. Líneas de telefonía fija Residenciales por departamento (`r FECHA_INFORME_TITULOS`)
...
## 11. Kilómetros de fibra óptica instalada por departamento (`r FECHA_INFORME_TITULOS`)
...
## 14. Minutos de tráfico de telefonía fija a teléfonos móviles por operador (`r FECHA_INFORME_TITULOS_2`)
