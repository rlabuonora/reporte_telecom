...
## 4.1. Ingresos Telefonía Móvil (pesos)
...
## 4.3. Cantidad de radiobases por departamento (`r FECHA_TITULO_STOCK`)
```{r}
tabla_91 <- radiobases %>% 
  filter(tipo == "Radiobases (total)") %>% 
...
## 4.4. Cantidad de radiobases por operador (`r FECHA_TITULO_STOCK`)
...
## 4.5. Cantidad de radiobases GSM
```{r}
radiobases %>% 
  filter(month(fecha) %in% c(6, 12)) %>% 
...
## 4.6. Cantidad de radiobases GSM por departamento (`r FECHA_TITULO_STOCK`)
...
## 4.7. Cantidad de radiobases GSM por operador (`r FECHA_TITULO_STOCK`)
...
## 4.9. Cantidad de radiobases 3G por departamento (`r FECHA_TITULO_STOCK`)
...
## 4.10. Cantidad de radiobases 3G por operador (`r FECHA_TITULO_STOCK`)
...
## 4.11. Cantidad de radiobases LTE
```{r}
radiobases %>% 
  filter(month(fecha) %in% c(6, 12)) %>% 
...
## 4.12. Cantidad de radiobases LTE por departamento (`r FECHA_TITULO_STOCK`)
...
## 4.13. Cantidad de radiobases LTE por operador (`r FECHA_TITULO_STOCK`)
