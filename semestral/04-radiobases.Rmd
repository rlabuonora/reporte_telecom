...
serie_90 <- radiobases %>% 
  ...
  serie_historica_mensual(radiobases, nudge_text = 5e2)
```




## 71. Cantidad de radiobases por departamento (`r FECHA_INFORME_TITULOS`)
```{r}
tabla_91 <- radiobases %>% 
  filter(tipo == "Radiobases (total)") %>% 
...
## 72. Cantidad de radiobases por operador (`r FECHA_INFORME_TITULOS`)
...
## 74. Cantidad de radiobases GSM por departamento (`r FECHA_INFORME_TITULOS`)
...
## 75. Cantidad de radiobases GSM por operador (`r FECHA_INFORME_TITULOS`)
...
## 77. Cantidad de radiobases 3G por departamento (`r FECHA_INFORME_TITULOS`)
...
## 78. Cantidad de radiobases 3G por operador (`r FECHA_INFORME_TITULOS`)
...
## 80. Cantidad de radiobases LTE por departamento (`r FECHA_INFORME_TITULOS`)
...
## 81. Cantidad de radiobases LTE por operador (`r FECHA_INFORME_TITULOS`)
