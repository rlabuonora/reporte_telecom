...
## Tráfico de datos de servicios de banda ancha fija (terabytes)
```{r}
banda_ancha_trafico %>%
...
## Tráfico de datos de servicios de banda ancha fija (terabytes) según alámbrica e inalámbrica (`r FECHA_TITULO_FLUJO`)
...
## Tráfico de datos se servicios de banda ancha fija (terabytes) según tipo de cliente (`r FECHA_TITULO_FLUJO`)
