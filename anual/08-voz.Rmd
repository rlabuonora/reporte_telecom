...
## Tráfico de voz a red fija de suscripciones móviles prepagos (minutos)
```{r}
serie_2020 <- voz %>%
...
## Tráfico de voz a red fija de suscripciones móviles prepagos (minutos) por operador (`r FECHA_TITULO_FLUJO`)
...
## Tráfico de voz de suscripciones móviles pospagos (minutos) por operador (`r FECHA_TITULO_FLUJO`)
