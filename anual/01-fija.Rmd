...
fija %>% 
  ...
  mutate(fecha = as.Date(paste(anio, "01", "01", sep = "-")),
         minutos_mill = minutos/1e6) %>% 
  serie_historica(minutos_mill, fecha, nudge_text = 1e2) +
  labs(y="Millones")
```
...
fija %>% 
  ...
  mutate(fecha = as.Date(paste(anio, "01", "01", sep = "-")),
         minutos_mill = minutos/1e6) %>% 
  serie_historica(minutos_mill, fecha, nudge_text = 2e1) +
  labs(y="Millones")
```
...
fija %>% 
  ...
  mutate(fecha = as.Date(paste(anio, "01", "01", sep = "-")),
         minutos_mill = minutos/1e6) %>% 
  serie_historica(minutos_mill, fecha, nudge_text = 12) +
  labs(y="Millones")
```
...
fija %>% 
  ...
  mutate(fecha = as.Date(paste(anio, "01", "01", sep = "-")),
         minutos_mill = minutos/1e6) %>% 
  serie_historica(minutos_mill, fecha, nudge_text = 8) +
  labs(y="Millones")
```
...
fija %>% 
  ...
  mutate(fecha = as.Date(paste(anio, "01", "01", sep = "-")),
         minutos_mill = minutos/1e6) %>% 
  serie_historica(minutos_mill, fecha, nudge_text = 3) +
  labs(y="Millones")
```
